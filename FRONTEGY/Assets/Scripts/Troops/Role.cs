...
{  // This *could* be a class, which would make it possible to modify global role stats. But it would take some work
    ...
    public Sprite tooltipSprite { get { if (_tooltipSprite == null) Debug.LogWarning(this + " has no tooltipSprite"); return _tooltipSprite; } }
    
    [SerializeField] private int _id;
    [SerializeField] private RoleStats _baseStats;
    [SerializeField] private Sprite _tooltipSprite;
